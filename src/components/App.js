  ...
  return (
    <Layout>
      <Header className="header">
        <div className="logo"><h1><a href="/b2b-for-good"><img alt="GA Logo" src="https://ga-core.s3.amazonaws.com/production/uploads/program/default_image/6301/GA_Cog_Large_Red_RGB.png" /> <span>REP</span></a></h1></div>
